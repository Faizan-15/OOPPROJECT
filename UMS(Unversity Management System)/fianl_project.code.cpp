...
void mainn();//code is at 34 line
void student(string,string);//CODE IS AT 120 LINE
void edit_std();//CODE IS AT 455 LINE
void see_std();//CODE IS AT 438 LINE
void teacher(string,string);//CODE IS AT 178 LINE
void edit_tea();//CODE IS AT 579
void see_tea();//CODE IS AT 514
void admin(string, string);//CODE IS AT 220 LINE 
//void edit_admin();//PENDING
//void see_admin();//PENDING
void see_attend();//CODE IS AT 273 LINE
void in_attend();//CODE IS AT 285 LINE
void see_timetable();//CODE IS AT 261 LINE
void in_timetable();//CODE IS AT 352 LINE
void see_adporatal();//CODE IS AT 412 LINE
void see_faculity();//CODE IS AT 425 LINE
    ...
    for(int i=0;i<10;i++)
    {
    	if(a[i]==name)
    	{
    		...
    		//	cout<<"press 3 to take quiz "<<endl;
    			cout<<"press 3 to see student record "<<endl;
    			cout<<"choice :";
    			cin>>techo;
    			if(techo=='1')
    			{
